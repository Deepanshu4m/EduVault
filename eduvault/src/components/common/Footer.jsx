...
// Images
import EduVaultLogo from "../../assets/Logo/Logo-Full-Light.png";
                    ...
                    <div className="lg:w-[50%] flex flex-wrap flex-row justify-between pl-3 lg:pl-5 gap-3">
                        {FooterLink2.map((ele, i) => {
                            return (
                                <div
                                    key={i}
                                    className="w-[35%] lg:w-[30%] mb-7 lg:pl-0"
                                >
                                    <h1 className="text-richblack-50 font-semibold text-[16px]">
                                        {ele.title}
                                    </h1>
                   ...
                   px-3 cursor-pointer hover:text-richblack-50 transition-all duration-200`}
                    ...
                    <div className="text-center flex flex-col sm:flex-row ">
                        <div className="flex ">
                            ...
                            <Link
                                to="https://github.com/Deepanshu4m"
                                target="__blank"
                    ...
                    <div className="flex items-center">
                        <a
                            href="https://www.linkedin.com/in/deepanshu-gupta-b38a2b330/"
                        ...
                        <a
                            href="https://www.github.com/Deepanshu4m"
                            className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
